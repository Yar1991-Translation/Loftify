...
///  * [CustomCupertinoPageRoute], which is a [PageRoute] that leverages this mixin.
...
// A page-based version of CustomCupertinoPageRoute.
//
// This route uses the builder from the page to build its content. This ensures
// the content is up to date after page updates.
class _PageBasedCustomCupertinoPageRoute<T> extends PageRoute<T>
    with CupertinoRouteTransitionMixin<T> {
...
/// See also:
///
///  * [CustomCupertinoPageRoute], for a [PageRoute] version of this class.
class CupertinoPage<T> extends Page<T> {
  ...
  Route<T> createRoute(BuildContext context) {
    return _PageBasedCustomCupertinoPageRoute<T>(
