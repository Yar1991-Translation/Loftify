...
class ChewieThemeColorData {
  ...
  static List<ChewieThemeColorData> defaultLightThemes = [
    ChewieThemeColorData(
      id: "MintLight",
      name: "薄荷青",
      canvasColor: const Color(0xFFEFF5F3),
      scaffoldBackgroundColor: const Color(0xFFF4FBF9),
      cardColor: const Color(0xFFE9EFED),
      primaryColor: const Color(0xFF006A65),
      cursorColor: const Color(0xFF006A65),
      indicatorColor: const Color(0xFF006A65),
      textSelectionColor: const Color(0xFF006A65).withAlpha(70),
      textSelectionHandleColor: const Color(0xFF006A65),
      hintColor: const Color(0xFF3F4947),
      iconColor: const Color(0xFF3F4947),
      hoverColor: const Color(0x14006A65),
      splashColor: const Color(0x33006A65),
      highlightColor: const Color(0x24006A65),
      shadowColor: const Color(0x12000000),
      dividerColor: const Color(0xFFBEC9C7),
      borderColor: const Color(0xFFBEC9C7),
      appBarShadowColor: const Color(0xFFF4FBF9),
      appBarBackgroundColor: const Color(0xFFF4FBF9),
      appBarSurfaceTintColor: const Color(0xFFF4FBF9),
      textColor: const Color(0xFF161D1C),
      textLightGreyColor: const Color(0xFF6F7978),
      textDarkGreyColor: const Color(0xFF3F4947),
      buttonPrimaryColor: const Color(0xFF006A65),
      buttonSecondaryColor: const Color(0xFFE3E9E8),
      buttonHoverColor: const Color(0xFFDDE4E2),
      buttonLightHoverColor: const Color(0xFFE9EFED),
      buttonDisabledColor: const Color(0xFFD5DBDA),
      scrollBarThumbColor: const Color(0xFFBEC9C7),
      scrollBarThumbHoverColor: const Color(0xFF889391),
      scrollBarTrackColor: const Color(0xFFEFF5F3),
      scrollBarTrackHoverColor: const Color(0xFFE9EFED),
  ...
  static List<ChewieThemeColorData> defaultDarkThemes = [
    ChewieThemeColorData(
      ...
      id: "MintDark",
      name: "薄荷夜",
      canvasColor: const Color(0xFF161D1C),
      scaffoldBackgroundColor: const Color(0xFF0E1514),
      cardColor: const Color(0xFF1A2120),
      primaryColor: const Color(0xFF81D5CE),
      cursorColor: const Color(0xFF81D5CE),
      indicatorColor: const Color(0xFF81D5CE),
      textSelectionColor: const Color(0xFF81D5CE).withAlpha(70),
      textSelectionHandleColor: const Color(0xFF81D5CE),
      hintColor: const Color(0xFFBEC9C7),
      textColor: const Color(0xFFDDE4E2),
      textLightGreyColor: const Color(0xFF889391),
      textDarkGreyColor: const Color(0xFFBEC9C7),
      iconColor: const Color(0xFFBEC9C7),
      hoverColor: const Color(0x1481D5CE),
      splashColor: const Color(0x3381D5CE),
      highlightColor: const Color(0x2481D5CE),
      dividerColor: const Color(0xFF3F4947),
      borderColor: const Color(0xFF3F4947),
      shadowColor: Colors.black.withAlpha(84),
      appBarShadowColor: const Color(0xFF0E1514),
      appBarBackgroundColor: const Color(0xFF0E1514),
      appBarSurfaceTintColor: const Color(0xFF0E1514),
      buttonPrimaryColor: const Color(0xFF81D5CE),
      buttonSecondaryColor: const Color(0xFF252B2A),
      buttonDisabledColor: const Color(0xFF161D1C),
      buttonHoverColor: const Color(0xFF2F3635),
      buttonLightHoverColor: const Color(0xFF1A2120),
      scrollBarThumbColor: const Color(0xFF3F4947),
      scrollBarThumbHoverColor: const Color(0xFF6F7978),
      scrollBarTrackColor: const Color(0xFF161D1C),
      scrollBarTrackHoverColor: const Color(0xFF1A2120),
